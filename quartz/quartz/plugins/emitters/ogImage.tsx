      ...
      return {
        additionalHead: [
          (pageData) => {
            ...
            let userDefinedOgImagePath = (pageData.frontmatter?.socialImage ?? pageData.frontmatter?.image) as string | undefined

            if (typeof userDefinedOgImagePath === "string") {
              userDefinedOgImagePath = isAbsoluteURL(userDefinedOgImagePath)
                ? userDefinedOgImagePath
                : userDefinedOgImagePath.startsWith("/")
